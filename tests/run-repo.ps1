...
& (Join-Path $repo 'usbcheck.exe') $Drive 2>&1 | Tee-Object (Join-Path $evidence 'usb-before.txt')
...
& (Join-Path $repo 'repocheck.exe') $Drive $ExpectedSerial $manifest $blobs $readback $sessionFile 2>&1 |
...
& (Join-Path $repo 'usbcheck.exe') $Drive 2>&1 | Tee-Object (Join-Path $evidence 'usb-after.txt')
