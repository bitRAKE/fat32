...
Run-Check 'read-before' (Join-Path $repo 'build\win32\usbcheck.exe') @($Drive)
...
Run-Check 'native-fixture-read' (Join-Path $repo 'build\win32\usbcheck.exe') @($Drive)
$null=Assert-Identity
Run-Check 'write' (Join-Path $repo 'build\win32\usbcheck.exe') @($Drive,'--write-test')
$null=Assert-Identity
Run-Check 'directory' (Join-Path $repo 'build\win32\usbcheck.exe') @($Drive,'--directory-test')
Run-Check 'read-after' (Join-Path $repo 'build\win32\usbcheck.exe') @($Drive)
